...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void getAuthentication(String token) {
        ...
        Authentication authentication = new JwtAuthenticationToken(authorities, loginInfo, null);
        SecurityContextHolder.getContext().setAuthentication(authentication); // 현재 요청에서 언제든지 인증정보를 꺼낼 수 있도록 해준다.
    }
